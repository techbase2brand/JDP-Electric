      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.section}>
          ...
          <Text style={styles.paragraph}>
            By accessing and using the JDP Electrics mobile application, you
          ...
          <Text style={styles.paragraph}>
            Permission is granted to temporarily download one copy of the JDP
            Electrics app for personal, non-commercial transitory viewing only.
          ...
          <Text style={styles.paragraph}>
            The materials within JDP Electrics app are provided on an 'as is'
            basis. JDP Electrics makes no warranties, expressed or implied, and
          ...
          <Text style={styles.paragraph}>
            In no event shall JDP Electrics or its suppliers be liable for any
            damages (including, without limitation, damages for loss of data or
            profit, or due to business interruption) arising out of the use or
            inability to use the materials on JDP Electrics app, even if JDP
            Electrics or an authorized representative has been notified orally
          ...
          <Text style={styles.paragraph}>
            JDP Electrics reserves the right to revise these terms of service at
