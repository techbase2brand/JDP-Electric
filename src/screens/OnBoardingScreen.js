...
import { ELECTRICIAN_1_IMAGE, ELECTRICIAN_2_IMAGE, ELECTRICIAN_3_IMAGE } from '../assests/images';
...
const slides = [
    ...
    },
    {
        ...
        description: 'Collaborate smarter, resolve issues faster, and build better tech together.',
    ...
    return (
        <View style={[styles.container, flex]}>
            <View style={[styles.logoBox]}>
                <Image source={slides[currentIndex].image} style={{ width: "100%", height: hp(70), resizeMode: "cover" }} />
            </View>
            <View style={[styles.box]}>
                ...
                <View style={styles.bottomButtons}>
                    ...
                    <TouchableOpacity onPress={handleNext} style={[{ width: wp(10), height: wp(10), backgroundColor: blueColor, borderRadius: 5 }, alignJustifyCenter]}>
