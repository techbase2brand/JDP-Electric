...
import { View, Text, TouchableOpacity, StyleSheet, KeyboardAvoidingView, Platform, Alert, ImageBackground, Image } from 'react-native';
...
import { blackColor, blueColor, grayColor, lightOrangeColor, mediumGray, redColor, whiteColor } from '../constants/Color';
import SuccessModal from '../components/modal/SuccessModal';
import { EMAIL_NOT_RECEIVED, ENTER_FOUR_DIGIT_CODE, ENTER_FOUR_DIGIT_CODE_THAT_YOU_RECEIVED, ENTER_YOU_EMAIL, FORGOT_PASSWORD, PASSWORD, RESEND_CODE, RESET_PASSWORD, SET_THE_NEW_PASSWORD } from '../constants/Constants';
    ...
    return (
        <KeyboardAvoidingView style={[flex]} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
            ...
            <View style={[styles.container, { backgroundColor: whiteColor, }]}>
                ...
                {currentStep === 'otp' && (
                    <View style={styles.box}>
                        <Text style={[styles.text, textAlign]}>{ENTER_FOUR_DIGIT_CODE}</Text>
                        <Text style={[styles.destext, textAlign]}>{ENTER_FOUR_DIGIT_CODE_THAT_YOU_RECEIVED}({email})</Text>
